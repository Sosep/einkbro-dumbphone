...
class ConfigManager(
    ...
    var clearIndexedDB by BooleanPreference(sp, K_CLEAR_INDEXEDDB, true)
    var clearCookies by BooleanPreference(sp, K_CLEAR_COOKIES, true)
    var clearHistory by BooleanPreference(sp, K_CLEAR_HISTORY, true)
    var clearWhenQuit by BooleanPreference(sp, K_CLEAR_WHEN_QUIT, true)
